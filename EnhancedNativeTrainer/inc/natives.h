...
namespace PLAYER
{
	...
	static void SET_PLAYER_WANTED_LEVEL_NO_DROP(Player player, int wantedLevel, Vehicle p2) { invoke<Void>(0x340E61DE7F471565, player, wantedLevel, p2); } // 0x340E61DE7F471565 0xED6F44F5
...
namespace ENTITY
{
	...
	static void ATTACH_ENTITY_TO_ENTITY(Entity entity1, Entity entity2, int boneIndex, float x, float y, float z, float xRot, float yRot, float zRot, BOOL p9, BOOL isRelatve, BOOL collision, BOOL allowRotation, int flag, BOOL p14) { invoke<Void>(0x6B9BBD38AB0796DF, entity1, entity2, boneIndex, x, y, z, xRot, yRot, zRot, p9, isRelatve, collision, allowRotation, flag, p14); } // 0x6B9BBD38AB0796DF 0xEC024237
	static void ATTACH_ENTITY_TO_ENTITY_PHYSICALLY(Entity entity1, Entity entity2, int boneIndex, int boneIndex2, float x1, float y1, float z1, float x2, float y2, float z2, float xRot, float yRot, float zRot, float forceToBreak, BOOL p14, BOOL p15, BOOL collision, BOOL p17, int p18) { invoke<Void>(0xC3675780C92F90F9, entity1, entity2, boneIndex, boneIndex2, x1, y1, z1, x2, y2, z2, xRot, yRot, zRot, forceToBreak, p14, p15, collision, p17, p18); } // 0xC3675780C92F90F9 0x0547417F
...
namespace PED
{
	...
	static void CLEAR_PED_DAMAGE_DECAL_BY_ZONE(Any p0, Any p1, Any* p2) { invoke<Void>(0x523C79AEEFCC4A2A, p0, p1, p2); } // 0x523C79AEEFCC4A2A 0x70AA5B7D
...
namespace VEHICLE
{
	...
	static void SET_DISABLE_VEHICLE_PETROL_TANK_FIRES(Vehicle vehicle, BOOL p1) { invoke<Void>(0x465BF26AB9684352, vehicle, p1); } // 0x465BF26AB9684352 0xC40192B5
	...
	static void ATTACH_VEHICLE_TO_TOW_TRUCK(Vehicle towTruck, Vehicle vehicle, int p2, float hookOffsetX, float hookOffsetY, float hookOffsetZ) { invoke<Void>(0x29A16F8D621C4508, towTruck, vehicle, p2, hookOffsetX, hookOffsetY, hookOffsetZ); } // 0x29A16F8D621C4508 0x8151571A
	...
	static void SET_VEHICLE_CEILING_HEIGHT(Any p0, float p1) { invoke<Void>(0xA46413066687A328, p0, p1); } // 0xA46413066687A328 0x98A10A86
...
namespace OBJECT
{
	...
	static BOOL PLACE_OBJECT_ON_GROUND_PROPERLY(Any object) { return invoke<BOOL>(0x58A850EAEE20FAA3, object); } // 0x58A850EAEE20FAA3 0x8F95A20B
	...
	static Object GET_CLOSEST_OBJECT_OF_TYPE(float x, float y, float z, float radius, Hash modelHash, BOOL p5, BOOL p6, BOOL p7) { return invoke<Object>(0xE143FA2249364369, x, y, z, radius, modelHash, p5, p6, p7); } // 0xE143FA2249364369 0x45619B33
	...
	static Pickup CREATE_PICKUP_ROTATE(Hash adfadsf, float posX, float posY, float posZ, float rotX, float rotY, float rotZ, int p7, int amount, Any p9, BOOL p10, Hash modelHash) { return invoke<Pickup>(0x891804727E0A98B7, adfadsf, posX, posY, posZ, rotX, rotY, rotZ, p7, amount, p9, p10, modelHash); } // 0x891804727E0A98B7 0xF015BFE2
	...
	static Pickup _CREATE_UNK1_PICKUP(Hash pickupType, float x, float y, float z, BOOL p4, Hash modelHash) { return invoke<Pickup>(0x125494B98A21AAF7, pickupType, x, y, z, p4, modelHash); } // 0x125494B98A21AAF7 0x56A02502
...
namespace AI
{
	...
	static void TASK_PLANT_BOMB(Ped p0, float x, float y, float z, float degreeAngle) { invoke<Void>(0x965FEC691D55E9BF, p0, x, y, z, degreeAngle); } // 0x965FEC691D55E9BF 0x33457535
	...
	static void _0xD5BB4025AE449A4E(Player p0, char* p1, float p2) { invoke<Void>(0xD5BB4025AE449A4E, p0, p1, p2); } // 0xD5BB4025AE449A4E 0xA79BE783
...
namespace INTERIOR
{
	...
	static Any _GET_ROOM_KEY_FROM_GAMEPLAY_CAM() { return invoke<Any>(0xA6575914D2A0B450); } // 0xA6575914D2A0B450 0x4FF3D3F5
...
namespace UI
{
	...
	static int _SET_NOTIFICATION_MESSAGE_CLAN_TAG_2(char* picName1, char* picName2, BOOL flash, int iconType1, char* sender, char* subject, float duration, char* clanTag, int iconType2, int unk) { return invoke<int>(0x531B84E7DA981FB6, picName1, picName2, flash, iconType1, sender, subject, duration, clanTag, iconType2, unk); } // 0x531B84E7DA981FB6 0xDEB491C8
	...
	static Any _0xBFEFE3321A3F5015(Ped pedId, char* username, BOOL pointedClanTag, BOOL isRockstarClan, char* clanTag, Any p5) { return invoke<Any>(0xBFEFE3321A3F5015, pedId, username, pointedClanTag, isRockstarClan, clanTag, p5); } // 0xBFEFE3321A3F5015 0xF5CD2AA4
	...
	static void _0x63BB75ABEDC1F6A0(Any headDisplayId, Any sprite, BOOL enabled) { invoke<Void>(0x63BB75ABEDC1F6A0, headDisplayId, sprite, enabled); } // 0x63BB75ABEDC1F6A0 0xD41DF479
	static void _0xEE76FF7E6A0166B0(Any p0, BOOL p1) { invoke<Void>(0xEE76FF7E6A0166B0, p0, p1); } // 0xEE76FF7E6A0166B0 0x767DED29
	static void _0xA67F9C46D612B6F1(Any playerHeadId, BOOL p1) { invoke<Void>(0xA67F9C46D612B6F1, playerHeadId, p1); } // 0xA67F9C46D612B6F1 0xB01A5434
	...
	static BOOL IS_MEDICAL_DISABLED() { return invoke<BOOL>(0xE18B138FABC53103); } // 0xE18B138FABC53103 0x94C834AD
...
namespace GRAPHICS
{
	...
	static void DRAW_SCALEFORM_MOVIE(int handle, float x, float y, float width, float height, int r, int g, int b, int a, int unkb) { invoke<Void>(0x54972ADAF0294A93, handle, x, y, width, height, r, g, b, a, unkb); } // 0x54972ADAF0294A93 0x48DA6A58
	static void DRAW_SCALEFORM_MOVIE_FULLSCREEN(int scaleform, int r, int g, int b, int a, Any unkb) { invoke<Void>(0x0DF606929C105BE1, scaleform, r, g, b, a, unkb); } // 0x0DF606929C105BE1 0x7B48E696
...
namespace WORLDPROBE
{
	...
	static int _0x65287525D951F6BE(int rayHandle, BOOL* hit, Vector3* endCoords, Vector3* surfaceNormal, int* _materialHash, Entity* entityHit) { return invoke<int>(0x65287525D951F6BE, rayHandle, hit, endCoords, surfaceNormal, _materialHash, entityHit); } // 0x65287525D951F6BE 0x4301E10C
...
namespace NETWORK
{
	...
	static Player _NETWORK_GET_PLAYER_PED(Player player) { return invoke<Player>(0x6C0E2E0125610278, player); } // 0x6C0E2E0125610278 0x40DBF464
	...
	static Entity NETWORK_GET_ENTITY_KILLER_OF_PLAYER(Player player, Any* p1) { return invoke<Entity>(0x42B2DAA6B596F5F8, player, p1); } // 0x42B2DAA6B596F5F8 0xA7E7E04F
	...
	static BOOL _0x187382F8A3E0A6C3(Any p0) { return invoke<BOOL>(0x187382F8A3E0A6C3, p0); } // 0x187382F8A3E0A6C3 0xA78571CA
...
{
	static void NETWORK_INITIALIZE_CASH(Any p0, Any p1) { invoke<Void>(0x3DA5ECD1A56CBA6D, p0, p1); } // 0x3DA5ECD1A56CBA6D 0x66DA9935
	...
	static void NETWORK_GIVE_PLAYER_JOBSHARE_CASH(int amount, Any* p1) { invoke<Void>(0xFB18DF9CB95E0105, amount, p1); } // 0xFB18DF9CB95E0105 0xC6047FDB
	static void NETWORK_RECEIVE_PLAYER_JOBSHARE_CASH(int amount, Any* p1) { invoke<Void>(0x56A3B51944C50598, amount, p1); } // 0x56A3B51944C50598 0x4ED71C1A
	static Any _0x1C2473301B1C66BA() { return invoke<Any>(0x1C2473301B1C66BA); } // 0x1C2473301B1C66BA 0xA27B9FE8
	static void NETWORK_REFUND_CASH(Any p0, Any* p1, Any* p2, BOOL p3) { invoke<Void>(0xF9C812CD7C46E817, p0, p1, p2, p3); } // 0xF9C812CD7C46E817 0x07C92F21
	...
	static BOOL _IS_ITEM_AVAILABLE(Any p0, BOOL p1, BOOL p2, BOOL p3, Any p4) { return invoke<BOOL>(0xAB3CAA6B422164DA, p0, p1, p2, p3, p4); } // 0xAB3CAA6B422164DA 0x5AA379D9
