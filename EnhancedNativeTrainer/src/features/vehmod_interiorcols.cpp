...
char* SUPPORTS_DIAL_AND_TRIM_COLOUR[] = { "BANSHEE2", "BUCCANEER2", "CHINO2", "FACTION2", "MOONBEAM2", "SULTANRS", "PRIMO2", "VOODOO", "SABREGT2" };
char* SUPPORTS_TRIM_COLOUR[] = { "SCHAFTER3", "SCHAFTER4", "SCHAFTER5", "SCHAFTER6", "COG55", "COG552", "COGNOSCENTI", "COGNOSCENTI2", "BALLER3", "BALLER4", "BALLER5", "BALLER6","SABREGT2" };
